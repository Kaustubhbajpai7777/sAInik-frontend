...
import { Flame, FileText, Video, ClipboardCheck, Bell } from 'lucide-react';
...
export default function Dashboard() {
  ...
  return (
    // Using theme-aware colors
    <div className="min-h-full bg-background text-foreground p-4 sm:p-6 lg:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mt-6 sm:mt-8">
          {stats && (
            <div className="bg-card p-4 sm:p-6 rounded-lg flex items-center gap-3 sm:gap-4 border border-brand-orange">
              <Flame size={32} className="text-brand-orange sm:w-10 sm:h-10" />
              <div>
          ...
          <div className="bg-card p-4 sm:p-6 rounded-lg flex items-center gap-3 sm:gap-4 border">
            <FileText size={32} className="text-blue-500 sm:w-10 sm:h-10" />
            <div>
              <p className="text-xl sm:text-2xl font-bold">{dashboardData?.totalContent || 0}</p>
              <p className="text-xs sm:text-sm text-muted-foreground">Content Processed</p>
            </div>
          </div>
          
          <div className="bg-card p-4 sm:p-6 rounded-lg flex items-center gap-3 sm:gap-4 border">
            <ClipboardCheck size={32} className="text-green-500 sm:w-10 sm:h-10" />
            <div>
              <p className="text-xl sm:text-2xl font-bold">{dashboardData?.totalQuizzes || 0}</p>
              <p className="text-xs sm:text-sm text-muted-foreground">Quizzes Taken</p>
            </div>
          </div>
          ...
          <div className="bg-card p-4 sm:p-6 rounded-lg flex items-center gap-3 sm:gap-4 border">
            ...
            <div>
              <p className="text-xl sm:text-2xl font-bold">{dashboardData?.averageScore || 0}%</p>
        ...
        {/* Quick Actions */}
        <div className="mt-6 sm:mt-8 bg-card p-4 sm:p-6 rounded-lg border">
          <h2 className="text-xl sm:text-2xl font-bold mb-4 text-brand-orange">Quick Actions</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3 sm:gap-4">
            <Link href="/summarizer" className="flex items-center gap-3 p-4 bg-orange-600 hover:bg-orange-700 rounded-lg transition-colors text-white touch-manipulation">
              <FileText size={20} className="flex-shrink-0" />
              <span className="font-semibold text-sm sm:text-base">Process New Content</span>
            </Link>
            <Link href="/history" className="flex items-center gap-3 p-4 bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors text-white touch-manipulation">
              <ClipboardCheck size={20} className="flex-shrink-0" />
              <span className="font-semibold text-sm sm:text-base">View Content History</span>
            </Link>
            <Link href="/chat/general" className="flex items-center gap-3 p-4 bg-green-600 hover:bg-green-700 rounded-lg transition-colors text-white touch-manipulation">
              <div className="text-lg flex-shrink-0">💬</div>
              <span className="font-semibold text-sm sm:text-base">Join Study Room</span>
            </Link>
            <Link href="/upsc-files" className="flex items-center gap-3 p-4 bg-purple-600 hover:bg-purple-700 rounded-lg transition-colors text-white touch-manipulation">
              <Bell size={20} className="flex-shrink-0" />
              <span className="font-semibold text-sm sm:text-base">UPSC Notifications</span>
            </Link>
            <Link href="/microtasks" className="flex items-center gap-3 p-4 bg-indigo-600 hover:bg-indigo-700 rounded-lg transition-colors text-white touch-manipulation">
              <div className="text-lg flex-shrink-0">🎯</div>
              <span className="font-semibold text-sm sm:text-base">AI Microtasks</span>
            </Link>
          </div>
        </div>
        ...
        <div className="mt-6 sm:mt-8 grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="bg-card p-4 sm:p-6 rounded-lg border">
            <h3 className="text-lg sm:text-xl font-bold mb-4 text-brand-orange">Today's Progress</h3>
          ...
          <div className="bg-card p-6 rounded-lg border">
            <h3 className="text-xl font-bold mb-4 text-brand-orange">AI Microtasks Overview</h3>
            <div className="space-y-3">
              ...
              <div className="mt-4">
                <Link href="/microtasks" className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-md transition-colors text-sm">
                  <div>🎯</div>
                  <span>Manage Microtasks</span>
                </Link>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mt-6 sm:mt-8">
          <div className="bg-card p-4 sm:p-6 rounded-lg border">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg sm:text-2xl font-bold text-brand-orange">Recent Content</h2>
              <Link href="/history" className="text-orange-500 hover:text-orange-600 text-xs sm:text-sm touch-manipulation">View All</Link>
            </div>
            <div className="space-y-3">
