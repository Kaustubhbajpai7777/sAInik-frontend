...
export default function Register() {
  ...
  return (
    <AuthGuard requireAuth={false}>
      <div className="flex min-h-screen flex-col items-center justify-center bg-background text-foreground px-4 py-8">
        <div className="w-full max-w-md p-6 sm:p-8 space-y-6 bg-card rounded-lg shadow-md">
          <h1 className="text-2xl sm:text-3xl font-bold text-center text-brand-orange">Register for sAInik</h1>
